...
public class STRINGS {
	...
	/**
	 * Tries to obtain a correct string representation of the object, including when
	 * it is an array (or an array of arrays). Made public to be used outside the
	 * debug sessions
	 *
	...
	/**
	 * A utility method for padding a string with spaces in order to obtain a length
	 * of "minLength"
	 *
	 * @param string    the string to pad
	 * @param minLength the minimum length to reach (if the string is longer, it
	...
	/**
	 * A utility method for padding a string with any character in order to obtain a
	 * length of "minLength"
	 *
	 * @param string    the string to pad
	 * @param minLength the minimum length to reach (if the string is longer, it
