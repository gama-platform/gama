 ...
 * 
 * <p>
 * This interface extends {@link IStatementDescription} to provide additional capabilities specific to
 * actions - named, reusable behaviors that can be invoked on agents. Actions are a fundamental building
 * block of agent behavior in GAMA, supporting both user-defined and built-in (primitive) implementations.
 * </p>
 * 
 * <h2>Purpose</h2>
 * 
...
public interface IActionDescription extends IStatementDescription {
	 ...
	 * 
	 * <p>
	 * Short documentation is a concise description of the action suitable for tooltips,
	 * quick help, and outline views. It typically includes the action signature and
	 * a brief description.
	 * </p>
	 *
	 * @param includeMetaData whether to include metadata (defining plugin, etc.) in the documentation
	 ...
	 * }</pre>
	 *
	 * @param callerContext the description of the statement invoking this action
	 ...
	 * 
	 * <p>
	 * This method is used only for primitive (built-in) actions to link the GAML action
	 * description with its Java implementation. The helper will be invoked when the action
	 * is executed.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 ...
	 * }</pre>
	 * 
	 * <p><b>Default Implementation:</b> Does nothing. Override for primitive actions.</p>
	 *
	 * @param helper the helper object that implements the action logic
	 * @param method the Java method that implements the action
	 */
	default void setHelper(final IGamaHelper helper, final AccessibleObject method) {}

	/**
	 * Adds a child description to this action.
	 * 
	 * <p>
	 * Actions can have child descriptions representing local variables, nested statements,
	 * or other elements defined within the action body.
	 * </p>
	 *
	 ...
	 * 
	 * <p>
	 * For primitive (built-in) actions, this returns the Java helper that executes
	 * the action logic. For user-defined actions, this returns null.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
	 ...
	 * }</pre>
	 * 
	 * <p><b>Default Implementation:</b> Returns {@code null}.</p>
	 *
