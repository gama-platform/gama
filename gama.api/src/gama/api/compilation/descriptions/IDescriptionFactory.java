 ...
 * 
 * <p>
 * This interface provides factory methods for constructing {@link IDescription} instances that represent
 * the semantic structure of GAML models. It serves as the central creation point for all types of descriptions
 * during model compilation, from high-level model and species descriptions to low-level statement and variable
 * descriptions.
 * </p>
 * 
 * <h2>Purpose</h2>
 ...
 * ISpeciesDescription species = factory.createBuiltInSpeciesDescription(
 *     "agent",
 *     IAgent.class,
 *     null, // no macro
 *     null, // no parent
 ...
 * IDescription desc = factory.create(
 *     "action",
 *     parentDesc,
 *     children,
 *     "name", "my_action",
 ...
 * 
 * <p>
 * Factory implementations are typically not thread-safe. Description creation should be performed
 * sequentially during the compilation phase. However, once created, descriptions are generally
