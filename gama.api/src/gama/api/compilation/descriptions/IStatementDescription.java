 ...
 * 
 * <p>
 * This interface extends {@link IDescription} to provide additional capabilities specific to
 * executable statements in GAML models. Statements represent behavioral elements such as actions,
 * reflexes, control structures (if, loop), and other executable blocks.
 * </p>
 * 
 * <h2>Purpose</h2>
 * 
...
public interface IStatementDescription extends IDescription {
	 ...
	 * 
	 * <p>
	 * Formal arguments are the parameter declarations in action signatures and other parametrized
	 * statements. Each argument is described by an {@link IDescription} (typically a variable description)
	 * that includes name, type, and optional default value.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
	 ...
	 * 
	 * <p>
	 * For statement descriptions that represent invocations (do, call, etc.), this method
	 * returns the actual arguments provided by the caller. The Arguments object maps
	 * argument names to their expression values.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
	 ...
	 * 
	 * <p>
	 * <b>Note:</b> This is only meaningful for statement descriptions representing invocations,
	 ...
	 * 
	 * <p>
	 * A super invocation calls the parent species' implementation of an action,
	 * typically using the {@code invoke} statement with the {@code super} keyword.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
	 ...
	 * }</pre>
	 * 
	 * <p><b>Default Implementation:</b> Returns {@code false}.</p>
	 *
	 ...
	 * 
	 * <p>
	 * Continuable statements are loops where {@code continue} can be used to skip
	 * to the next iteration. This includes {@code loop}, {@code ask} over collections, etc.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
	 ...
	 * 
	 * <p>
	 * Breakable statements are loops and switches where {@code break} can be used to
	 * exit early. This includes {@code loop}, {@code switch}, {@code ask} over collections, etc.
	 * </p>
	 * 
	 * <h3>Example:</h3>
	 * <pre>{@code
