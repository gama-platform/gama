 ...
 *
 * <p>
 * This interface defines the contract for objects that reference variables defined in species, enabling dependency
 * tracking and analysis. It is primarily implemented by expressions and descriptions that need to track which species
 * attributes they use.
 * </p>
 *
 * <h2>Purpose</h2>
 ...
 *
 * <p>
 * The {@link #collectUsedVarsOf(ISpeciesDescription, ICollector, ICollector)} method performs recursive dependency
 * analysis:
 * </p>
 * <ol>
 ...
 *
 * <p>
 * The {@code alreadyProcessed} collector prevents infinite recursion and redundant analysis when expressions have
 * shared sub-expressions or circular references.
 * </p>
 *
...
public interface IVarDescriptionUser {
	 ...
	 *
	 * <p>
	 * This method performs dependency analysis to identify which attributes defined in the given species are referenced
	 * by this expression or description (and recursively by any sub-expressions or child descriptions).
	 * </p>
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <b>Default Implementation:</b> Does nothing (no variables used).
	 * </p>
	 *
	 * @param species
	 *            the species description whose variables to track
	 * @param alreadyProcessed
	 *            collector of already analyzed IVarDescriptionUser objects (used to prevent redundant analysis and
	 *            infinite recursion)
	 * @param result
	 *            collector that will be filled with variable descriptions from {@code species} that are used by this
	 *            object or its sub-components
	 */
