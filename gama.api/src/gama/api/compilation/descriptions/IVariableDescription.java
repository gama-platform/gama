 ...
 *
 * <p>
 * This interface extends {@link IDescription} to provide capabilities specific to variable (attribute) declarations in
 * GAML models. Variables represent agent state and can be defined at different levels (global, species, experiment)
 * with various properties controlling initialization, updates, and access.
 * </p>
 *
 * <h2>Purpose</h2>
 *
 ...
 *
 * <p>
 * Variables can depend on other variables in their initialization or update expressions. The
 * {@link #getDependencies(Set, boolean, boolean)} method analyzes these dependencies:
 * </p>
 *
 * <pre>{@code
 ...
 *
 * <p>
 * Platform-provided variables (like {@code location}, {@code shape}, {@code name}) have Java implementations accessible
 * via helpers:
 * </p>
 * <ul>
...
public interface IVariableDescription extends IDescription {
	...
	Set<String> INIT_DEPENDENCIES_FACETS =
			Set.of(IKeyword.INIT, IKeyword.MIN, IKeyword.MAX, IKeyword.STEP, IKeyword.SIZE, IKeyword.AMONG);

	/** The Constant UPDATE_DEPENDENCIES_FACETS. */
	Set<String> UPDATE_DEPENDENCIES_FACETS = Set.of(IKeyword.UPDATE, IKeyword.VALUE, IKeyword.MIN, IKeyword.MAX);

	/** The Constant FUNCTION_DEPENDENCIES_FACETS. */
	Set<String> FUNCTION_DEPENDENCIES_FACETS = Set.of(IKeyword.FUNCTION);
