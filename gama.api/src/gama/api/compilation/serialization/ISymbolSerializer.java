 ...
 * syntactically valid GAML source code. Serializers are used for code generation, model transformation, refactoring,
 * and saving programmatically created models.
 * </p>
 *
 * <h2>Purpose</h2>
 *
...
public interface ISymbolSerializer extends IKeyword {
	...
	default String serializeFacetValue(final IDescription symbolDescription, final String key,
		...
		if (exprString.startsWith(IInternalFacets.INTERNAL)) return null;
		if (ed.isLabel()) {
