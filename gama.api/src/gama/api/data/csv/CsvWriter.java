...
public class CsvWriter extends AbstractCSVManipulator {
	...
	/**
	 * Creates a {@link gama.api.data.csv.csvreader.CsvWriter CsvWriter} object using a file as the data
	 * destination.
	 *
	 * @param fileName
	...
	/**
	 * Creates a {@link gama.api.data.csv.csvreader.CsvWriter CsvWriter} object using a Writer to write data to.
	 *
	 * @param outputStream
