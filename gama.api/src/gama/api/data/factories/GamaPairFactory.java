...
/**
 * A static factory for creating and managing {@link IPair} instances.
 * This class serves as a frontend for pair creation, delegating to an {@link IPairFactory}.
 * It allows creating pairs with specific types or inferred types, and converting objects to pairs.
 */
public class GamaPairFactory implements IFactory<IPair> {
	 ...
	 *             if conversion fails.
	 */
	public static IPair toPair(final IScope scope, final Object obj, final IType keyType, final IType contentsType,
	 ...
	 * @return the created {@link IPair}.
	 */
	public static IPair toPair(final IScope scope, final Object val) {
	 ...
	 * @return the created {@link IPair}.
	 */
	public static IPair toPair(final IScope scope, final Object val, final boolean copy) {
