 ...
 */
public class GamaShapeFactory implements IFactory<IShape> {
	...
	public static IShape createFrom(final IScope scope, final Object obj, final boolean copy)
			throws GamaRuntimeException {
		return switch (obj) {
			case null -> null;
	...
	public static IShape pairToGeometry(final IScope scope, final IPair p) throws GamaRuntimeException {
		final IShape first = createFrom(scope, p.first(), false);
		if (first == null) return null;
		final IShape second = createFrom(scope, p.last(), false);
