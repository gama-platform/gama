...
public interface GamlCoreUnits {
	...
	String ISO_LOCAL_KEY = "ISO_LOCAL_DATE_TIME";

	/** The Constant ISO_OFFSET_KEY. */
	String ISO_OFFSET_KEY = "ISO_OFFSET_DATE_TIME";

	/** The Constant ISO_ZONED_KEY. */
	String ISO_ZONED_KEY = "ISO_ZONED_DATE_TIME";

	/** The Constant ISO_SIMPLE_KEY. */
	String ISO_SIMPLE_KEY = "ISO_SIMPLE";
