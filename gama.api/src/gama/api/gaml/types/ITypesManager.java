 ...
 * ITypesManager BUILT_IN_TYPES = Types.BUILT_IN_TYPES;
 *
 * // Look up a type
 * IType<Integer> intType = BUILT_IN_TYPES.get("int");
 *
...
public interface ITypesManager extends IDisposable {
	 ...
	 *
	 * <p>
	 * The lookup searches this manager first, then delegates to the parent manager if not found. If no type is found in
	 * the entire hierarchy, returns {@link Types#NO_TYPE} instead of null.
	 * </p>
	 *
	 * <p>
	 * Examples:
	 ...
	 *
	 * <p>
	 * When a type is not found in this manager, the lookup is delegated to the parent. This creates a hierarchy: model
