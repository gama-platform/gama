/*******************************************************************************************************
 *
 * IPopulation.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
 ...
 *
 * <p>
 * A population is a managed collection of agents belonging to the same species in GAMA. It acts as both a container for
 * agents and a manager for their lifecycle (creation, initialization, scheduling, disposal).
 * </p>
 *
...
public interface IPopulation<T extends IAgent>
	 ...
	 */
	public interface Simulation extends IPopulation<ISimulationAgent> {
	 ...
	 * The Interface Grid.
	 */
	public interface Grid extends IPopulation<IAgent> {

		/**
		 * @param matrix
		 */
		void setGrid(IGrid matrix);
		 ...
		 */
		@Override
		default boolean isGrid() { return true; }
	 ...
	 */
	public interface Experiment extends IPopulation<IExperimentAgent> {
