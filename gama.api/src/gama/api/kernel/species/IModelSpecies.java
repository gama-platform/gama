/*******************************************************************************************************
 *
 * IModelSpecies.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface IModelSpecies extends ISpecies {
	 ...
	 */
	@Override
	IModelDescription getDescription();
	...
	@Override
	default URI getURI() {
		final IDescription md = getDescription();
