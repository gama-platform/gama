 ...
 * 
 * <p>
 * AgentExecutionContext uses an object pool to reduce allocation overhead during frequent context
 * creation/destruction. Always call {@link #dispose()} when done with a context to return it to the pool for reuse.
 * </p>
 * 
 * <p>
...
public class AgentExecutionContext implements IDisposable {
	...
	public AgentExecutionContext createCopy() {
		// Recursively copy the entire context chain to avoid side effects
	 ...
	 * is a simulation agent, it is returned directly. Otherwise, the method delegates to the agent's own getSimulation()
	 * method.
	 * </p>
	 * 
	 * <h3>Example</h3>
