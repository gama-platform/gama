/*******************************************************************************************************
 *
 * IScope.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface IScope extends Closeable, IBenchmarkable {
	 ...
	 */
	default void setServerConfiguration(final IServerConfiguration config) {
