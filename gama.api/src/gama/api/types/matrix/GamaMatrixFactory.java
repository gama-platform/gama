 ...
 */
public class GamaMatrixFactory {
	 ...
	 * @return the created {@link IMatrix}.
	 */
	public static IMatrix castToMatrix(final IScope scope, final Object obj, final Object param,
	 ...
	 * @return the created {@link IMatrix}.
	 */
	public static IMatrix castToMatrix(final IScope scope, final Object obj) {
		return castToMatrix(scope, obj, null, Types.NO_TYPE, false);
	}
	 ...
	 * @return the i field
	 */
	public static IField castToField(final IScope scope, final Object object) {
		return castToField(scope, object, null, null, false);
	}
	 ...
	 * @return the i field
	 */
	public static IField castToField(final IScope scope, final Object obj, final Object param, final IType contentType,
			final boolean copy) {
		if (obj == null && param == null) return null;
		final IPoint size = param instanceof IPoint i ? i : null;
		...
		if (size == null) {
			...
			if (obj instanceof ISpecies species && species.isGrid()) return castToField(scope,
					species.getPopulation(scope).getTopology().getPlaces(), param, contentType, copy);
			if (obj instanceof IContainer) return castToField(scope,
	...
	public static IField createFieldWithNoData(final IScope scope, final Object object, final double noData) {
		IField field = castToField(scope, object);
