...
public class AmorphousTopology implements ITopology {
	...
	/**
	 * @see gama.api.types.topology.environment.ITopology#normalizeLocation(gama.core.util.GamaPoint, boolean)
	 */
	@Override
	...
	/**
	 * @see gama.api.types.topology.environment.ITopology#getWidth()
	 */
	@Override
	public double getWidth() { return expandableEnvironment.getEnvelope().getWidth(); }

	/**
	 * @see gama.api.types.topology.environment.ITopology#getHeight()
	 */
	@Override
	public double getHeight() { return expandableEnvironment.getEnvelope().getHeight(); }

	/**
	 * @see gama.api.types.topology.environment.ITopology#dispose()
	 */
	@Override
	public void dispose() {}
	...
	/**
	 * @see gama.api.types.topology.ITopology#pathBetween(gama.core.metamodel.shape.GamaPoint,
