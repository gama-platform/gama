/*******************************************************************************************************
 *
 * IGraphics.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface IGraphics {
	 ...
	 */
	Rectangle2D drawAsset(IAsset asset, IDrawingAttributes attributes);
	 ...
	 * @return the rectangle 2 D
	 */
	Rectangle2D drawField(final IField values, final IDrawingAttributes attributes);
	 ...
	 * @return the rectangle 2 D
	 */
	Rectangle2D drawImage(final BufferedImage img, final IDrawingAttributes attributes);
	 ...
	 * @return the rectangle 2 D
	 */
	Rectangle2D drawChart(BufferedImage chart);
	 ...
	 * @return the rectangle 2 D
	 */
	Rectangle2D drawString(final String string, final IDrawingAttributes attributes);
	 ...
	 * @return the rectangle 2 D
	 */
	Rectangle2D drawShape(final Geometry shape, final IDrawingAttributes attributes);
	 ...
	 *            the layer
	 */
	void beginOverlay(ILayer layer);
