/*******************************************************************************************************
 *
 * ILayer.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface ILayer extends INamed, Comparable<ILayer> {
	 ...
	 * The Interface Chart.
	 */
	interface Chart extends ILayer {
	 ...
	 */
	default String getMenuName() { return getType() + IItemList.SEPARATION_CODE + getName(); }
	 ...
	 */
	IList<? extends IAgent> getAgentsForMenu(final IScope scope);
	 ...
	 */
	default IPoint getModelCoordinatesFrom(final int xOnScreen, final int yOnScreen, final IDisplaySurface g) {
	...
	default void getModelCoordinatesInfo(final int xOnScreen, final int yOnScreen, final IDisplaySurface g,
		...
		final IPoint point = getModelCoordinatesFrom(xOnScreen, yOnScreen, g);
