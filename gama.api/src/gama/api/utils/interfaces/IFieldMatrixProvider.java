/*******************************************************************************************************
 *
 * IFieldMatrixProvider.java, in gama.api, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
public interface IFieldMatrixProvider {
	...
	default IField getField(final IScope scope) {
		return GamaMatrixFactory.createFieldFromProvider(scope, this);
	}
