/*******************************************************************************************************
 *
 * ParallelMersenneTwisterRNG.java, in gama.core, is part of the source code of the GAMA modeling and simulation
 * platform (v.2025-03).
 *
...
public class ParallelMersenneTwisterRNG extends MersenneTwisterRNG {
	 ...
	 */
	public ParallelMersenneTwisterRNG(final IRandom seedGenerator) {
