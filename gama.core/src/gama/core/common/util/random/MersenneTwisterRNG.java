/*******************************************************************************************************
 *
 * MersenneTwisterRNG.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
public class MersenneTwisterRNG extends GamaRNG {
	 ...
	 */
	public MersenneTwisterRNG(final IRandom seedGenerator) {
