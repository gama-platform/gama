/*******************************************************************************************************
 *
 * GamaPointFactory.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
public class GamaPointFactory {
	...
	/** The null point. */
	public static Immutable NULL_POINT = new Immutable(0, 0, 0);
	 ...
	 */
	public static Immutable createImmutable(final double x, final double y, final double z) {
	 ...
	 * @return the immutable
	 */
	public static Immutable createImmutable(final double x, final double y) {
	 ...
	 * @return the immutable
	 */
	public static Immutable createImmutable(final IPoint p) {
	 ...
	 * @return the immutable
	 */
	public static Immutable createImmutable(final Coordinate p) {
		if (p == null) return NULL_POINT;
		return createImmutable(p.getX(), p.getY(), p.getZ());
	}
