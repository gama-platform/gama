...
public class GamlClass extends Symbol implements IClass {
	...
	/** The parent species. */
	protected IModelSpecies macroSpecies;
	...
	public static class ClassValidator implements IDescriptionValidator<IDescription> {
		...
		public void validate(final IDescription desc) {
			final IClassDescription sd = (IClassDescription) desc;
			/** The name. */
	 ...
	 */
	@Override
	public void setMacroSpecies(final ISpecies model) { macroSpecies = (IModelSpecies) model; }
