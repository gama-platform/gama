...
public abstract class AbstractOutputManager extends Symbol implements IOutputManager {
	...
	/**
	 * The Class ConcurrentLinkedReducedHashSet.
	 *
	 * @param <E>
	 *            the element type
	 */
	public static class ConcurrentLinkedReducedHashSet<E> implements Iterable<E> {
		...
		/**
		 * The insertion order maintained in a ConcurrentSkipListSet, so that we iterate in the correct order.
		 */
	...
	static class OutputMap implements Map<String, IOutput> {
		...
		@Override
		public boolean isEmpty() { return actualOutputs.isEmpty(); }
