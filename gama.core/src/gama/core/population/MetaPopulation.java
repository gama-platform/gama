...
public class MetaPopulation implements IContainer.ToGet<Integer, IAgent>, IPopulationSet {
	 ...
	 *
	 * @see gama.api.kernel.agent.IPopulationSet#getPopulations(gama.api.runtime.scope.IScope)
	 */
	@Override
