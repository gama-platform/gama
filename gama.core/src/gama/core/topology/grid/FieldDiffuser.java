/*******************************************************************************************************
 *
 * FieldDiffuser.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
public class FieldDiffuser {
	...
	/** The cache. */
	static LoadingCache<ISimulationAgent, FieldDiffuser> CACHE =
			CacheBuilder.newBuilder().build(new CacheLoader<ISimulationAgent, FieldDiffuser>() {

				@Override
				public FieldDiffuser load(final ISimulationAgent sim) {
