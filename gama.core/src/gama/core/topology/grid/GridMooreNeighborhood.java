/*******************************************************************************************************
 *
 * GridMooreNeighborhood.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * .
 *
...
public class GridMooreNeighborhood extends GridNeighborhood {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.core.topology.grid.INeighborhood#clear()
	 */
	@Override
	public void clear() {}
}