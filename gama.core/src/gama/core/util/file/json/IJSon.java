/*******************************************************************************************************
 *
 * IJSon.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface IJSon {
	 ...
	 * @date 5 nov. 2023
	 */
	JsonReferenceObject reference(String ref);
	 ...
	 * @date 29 oct. 2023
	 */
	IJsonObject agent(String species, int index);
	 ...
	 */
	IJsonValue parse(String string);
