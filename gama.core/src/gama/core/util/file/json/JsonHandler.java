/*******************************************************************************************************
 *
 * JsonHandler.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * .
 *
 ...
 * the methods of the given handler while reading the input.
 * <p>
 * The default implementations of these methods do nothing. Subclasses may override only those methods they are
 * interested in. They can use <code>getLocation()</code> to access the current character position of the parser at any
 ...
 * </pre>
 * <p>
 * Subclasses that build an object representation of the parsed JSON can return arbitrary handler objects for JSON
...
public abstract class JsonHandler<A, O> {
	 ...
	 * endArrayValue()}, and {@link #endArray(Object) endArray()} for this array.
	 * </p>
	 *
	 ...
	 *
	 * @param array
	 *            the array handler returned from {@link #startArray()}, or <code>null</code> if not provided
	 */
	 ...
	 * character of the member value, just after the <code>end</code> method for the specific member type (like
	 * {@link #endString(String) endString()}, {@link #endNumber(String) endNumber()}, etc.).
	 *
	 * @param object
	 *            the object handler returned from {@link #startObject()}, or null if not provided
