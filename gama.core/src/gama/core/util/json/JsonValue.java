...
public abstract class JsonValue implements Serializable, IJsonValue {
	 ...
	 */
	@Override
	public IJsonObject asGamlObject() {
	 ...
	 */
	public void writeTo(final Writer writer, final IJsonWriterConfig config) throws IOException {
	...
	public String toString() {
		return toString(IJsonWriterConfig.MINIMAL);
	}
	 ...
	 * @return a JSON string that represents this value
	 */
	public String toString(final IJsonWriterConfig config) {
	...
	public String toPrettyPrint() {
		return toString(IJsonWriterConfig.PRETTY_PRINT);
	}
