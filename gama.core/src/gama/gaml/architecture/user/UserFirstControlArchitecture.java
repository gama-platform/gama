/*******************************************************************************************************
 *
 * UserFirstControlArchitecture.java, in gama.core, is part of the source code of the GAMA modeling and simulation
 * platform (v.2025-03).
 *
...
public class UserFirstControlArchitecture extends UserControlArchitecture {
	 ...
	 * @param desc
	 */
	public UserFirstControlArchitecture(final IDescription desc) {
		super(desc);
	}
