/*******************************************************************************************************
 *
 * WeightedTasksArchitecture.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
public class WeightedTasksArchitecture extends ReflexArchitecture {
	 ...
	 * @param desc
	 */
	public WeightedTasksArchitecture(final IDescription desc) {
		super(desc);
	}
