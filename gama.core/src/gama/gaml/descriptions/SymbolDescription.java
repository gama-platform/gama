...
public abstract class SymbolDescription implements IDescription {
	 ...
	 */
	final static SymbolSerializer SYMBOL_SERIALIZER = new SymbolSerializer();

	/**
	 * The Constant VAR_SERIALIZER.
	 */
	final static VarSerializer VAR_SERIALIZER = new VarSerializer();

	/**
	 * The Constant SPECIES_SERIALIZER.
	 */
	final static SpeciesSerializer SPECIES_SERIALIZER = new SpeciesSerializer();

	/**
	 * The Constant MODEL_SERIALIZER.
	 */
	final static ModelSerializer MODEL_SERIALIZER = new ModelSerializer();

	/**
	 * The Constant STATEMENT_SERIALIZER.
	 */
	final static StatementSerializer STATEMENT_SERIALIZER = new StatementSerializer();
