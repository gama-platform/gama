/*******************************************************************************************************
 *
 * IAttributed.java, in gama.core, is part of the source code of the GAMA modeling and simulation platform (v.2025-03).
 *
...
public interface IAttributed {
	 ...
	 * @date 17 sept. 2023
	 */
	IMap<String, Object> getAttributes(boolean createIfNeeded);
