...
global {
	...
	init {
		// Test 1: Parse time with colons (HH:mm:ss)
		write "=== Test 1: Time with colons ===";
		date time1 <- date(['07:39:59', 'HH:mm:ss']);
		write "Parsed time1: " + time1;
		assert time1.hour = 7 and time1.minute = 39 and time1.second = 59;
		write "✓ Test 1 passed";
		
		// Test 2: Parse date with slashes (dd/MM/yyyy)
		write "\n=== Test 2: Date with slashes ===";
		...
		// Test 5: Traditional integer list format still works
