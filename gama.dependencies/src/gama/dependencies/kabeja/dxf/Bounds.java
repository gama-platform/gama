...
public class Bounds {
	...
	public void addToBounds(Bounds bounds) {
		if (bounds.getMaximumX() > this.getMaximumX()) { this.setMaximumX(bounds.getMaximumX()); }

		if (bounds.getMaximumY() > this.getMaximumY()) { this.setMaximumY(bounds.getMaximumY()); }

		if (bounds.getMaximumZ() > this.getMaximumZ()) { this.setMaximumZ(bounds.getMaximumZ()); }

		if (bounds.getMinimumX() < this.getMinimumX()) { this.setMinimumX(bounds.getMinimumX()); }

		if (bounds.getMinimumY() < this.getMinimumY()) { this.setMinimumY(bounds.getMinimumY()); }

		if (bounds.getMinimumZ() < this.getMinimumZ()) { this.setMinimumZ(bounds.getMinimumZ()); }
	}
	...
	public void addToBounds(double x, double y, double z) {
		if (x > this.getMaximumX()) { this.setMaximumX(x); }

		if (x < this.getMinimumX()) { this.setMinimumX(x); }

		if (y > this.getMaximumY()) { this.setMaximumY(y); }

		if (y < this.getMinimumY()) { this.setMinimumY(y); }

		if (z < this.getMinimumZ()) { this.setMinimumZ(z); }

		if (z > this.getMaximumZ()) { this.setMaximumZ(z); }
	}
	...
	public boolean isValid() {
		...
		// return false;
		// }
		if ((this.max_x == Double.NEGATIVE_INFINITY) || (this.max_y == Double.NEGATIVE_INFINITY)
				|| (this.min_x == Double.POSITIVE_INFINITY) || (this.min_y == Double.POSITIVE_INFINITY)) {
			return false;
		}
	...
	public boolean contains(Point p) {
		if ((this.min_x <= p.getX()) && (this.max_x >= p.getX())) {
			if ((this.min_y <= p.getY()) && (this.max_y >= p.getY())) { return true; }
		}
