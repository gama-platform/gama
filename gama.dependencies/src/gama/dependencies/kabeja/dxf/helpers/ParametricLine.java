...
public class ParametricLine {
	...
	public double getIntersectionParameter(ParametricLine line) {
		...
		if (MathUtils.absoluteValue(n) == 0.0) { return Double.POSITIVE_INFINITY; }

		Vector m = MathUtils.crossProduct(MathUtils.getVector(this.startPoint, line.getStartPoint()),
		...
		if (n.getX() != 0.0) {
			...
			s = m.getY() / n.getY();
		} else if (n.getZ() != 0.0) { s = m.getZ() / n.getZ(); }
	...
	public double getParameter(Point p) {
		...
		} else if (this.direction.getZ() != 0.0) { t = (p.getZ() - this.startPoint.getZ()) / this.direction.getZ(); }
