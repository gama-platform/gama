...
public class COUNTER {
	...
	/**
	 * Returns an automatically incremented integer count proper to the class of the
	 * calling object. Useful for counting a number of invocations, etc. without
	 * having to define a static number on the class
	 *
