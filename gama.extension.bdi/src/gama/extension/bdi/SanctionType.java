/*******************************************************************************************************
 *
 * SanctionType.java, in gama.extension.bdi, is part of the source code of the GAMA modeling and simulation platform .
 *
...
public class SanctionType extends GamaType<Sanction> {
	 ...
	 * @param support
	 */
	public SanctionType(final ITypesManager typesManager) {
		super(typesManager);
	}

	/** The Constant id. */
	//
	public final static int id = IType.BEGINNING_OF_CUSTOM_TYPES + 546661;
