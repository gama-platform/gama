...
class MultiShapeOutput implements Output, Iterable<IShape> {
	...
	public MultiShapeOutput() {
		currentStroke = new BasicStroke();
		currentTransform = new AffineTransform();
		currentClip = null;
	}

	private MultiShapeOutput(final MultiShapeOutput parent) {
	...
	public Output createChild() {
		return new MultiShapeOutput(this);
	}
	...
	private static class ShapeOutputSafeState implements SafeState {
		private final MultiShapeOutput shapeOutput;
		private final Stroke oldStroke;
		private final AffineTransform oldTransform;
		private final Area oldClip;

		private ShapeOutputSafeState(final MultiShapeOutput shapeOutput) {
