...
public class ImageDisplaySurface implements IDisplaySurface {
	...
	/**
	 * @see gama.api.ui.displays.IDisplaySurface#initialize(double, double, gama.core.outputs.IDisplayOutput)
	 */
	@Override
	 ...
	 * Method getData()
	 *
	 * @see gama.api.ui.displays.IDisplaySurface#getData()
	 */
	@Override
	 ...
	 *
	 * @see gama.api.ui.displays.IDisplaySurface#layersChanged()
	 */
	@Override
	 ...
	 *
	 * @see gama.api.ui.displays.IDisplaySurface#getVisibleRegionForLayer(gama.api.ui.layers.ILayer)
	 */
	@Override
