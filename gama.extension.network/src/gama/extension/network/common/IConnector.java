/*******************************************************************************************************
 *
 * IConnector.java, in gama.network, is part of the source code of the GAMA modeling and simulation platform .
 *
...
public interface IConnector {
	 ...
	 *            the data
	 */
	void send(IAgent agent, String dest, IMessage data);
