/*******************************************************************************************************
 *
 * PhysicsActivator.java, in gama.extension.physics, is part of the source code of the GAMA modeling and simulation
 * platform (v.2025-03).
 *
 ...
 */
public class PhysicsActivator extends GamaBundleActivator {
	...
	public static final String NATIVE_LIBRARY_LOCATION = "/libs/Libbulletjme 21.2.1/native/";
	...
	@Override
	protected void initialize(final BundleContext context) {
		loadNativeLibrary();
	}
