/*******************************************************************************************************
 *
 * SerialisedPopulationSerialiser.java, in gama.extension.serialize, is part of the source code of the GAMA modeling
...
/**
 * FST serialiser for {@link SerialisedPopulation} instances.
 * Persists the species name and the ordered list of serialised agents belonging to the population.
 *
...
class SerialisedPopulationSerialiser extends FSTIndividualSerialiser<SerialisedPopulation> {
	...
	/**
	 * Constructs a new {@code SerialisedPopulationSerialiser} bound to the given {@link BinarySerialiser}.
	 *
	 * @param serialiser
	 *            the owning binary serialiser
	 */
	SerialisedPopulationSerialiser(final BinarySerialiser serialiser) {
		super(serialiser);
	}
