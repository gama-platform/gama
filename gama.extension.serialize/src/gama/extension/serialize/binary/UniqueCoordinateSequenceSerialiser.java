/*******************************************************************************************************
 *
 * UniqueCoordinateSequenceSerialiser.java, in gama.extension.serialize, is part of the source code of the GAMA
...
/**
 * FST serialiser for {@link UniqueCoordinateSequence} instances.
 * A {@code UniqueCoordinateSequence} holds exactly one coordinate; serialisation persists
 * its x, y, and z components at index 0.
 *
...
class UniqueCoordinateSequenceSerialiser extends FSTIndividualSerialiser<UniqueCoordinateSequence> {
	...
	/**
	 * Constructs a new {@code UniqueCoordinateSequenceSerialiser} bound to the given {@link BinarySerialiser}.
	 *
	 * @param serialiser
	 *            the owning binary serialiser
	 */
	UniqueCoordinateSequenceSerialiser(final BinarySerialiser serialiser) {
		super(serialiser);
	}
