/*******************************************************************************************************
 *
 * RoadNodeSkill.java, in gama.extension.traffic, is part of the source code of the GAMA modeling and simulation
 * platform (v.2025-03).
 *
...
public class RoadNodeSkill extends Skill {
	 ...
	 * @param desc
	 */
	public RoadNodeSkill(final IDescription desc) {
		super(desc);
	}
