/*******************************************************************************************************
 *
 * MOBIL.java, in gaml.extensions.traffic, is part of the source code of the GAMA modeling and simulation
 * platform .
 *
...
import static gama.extension.traffic.driving.DrivingSkill.getAccBias;
import static gama.extension.traffic.driving.DrivingSkill.getAccGainThreshold;
import static gama.extension.traffic.driving.DrivingSkill.getAllowedLanes;
import static gama.extension.traffic.driving.DrivingSkill.getLCCooldown;
import static gama.extension.traffic.driving.DrivingSkill.getLaneChangeLimit;
import static gama.extension.traffic.driving.DrivingSkill.getLeadingDistance;
import static gama.extension.traffic.driving.DrivingSkill.getMaxSafeDeceleration;
import static gama.extension.traffic.driving.DrivingSkill.getNumLanesOccupied;
import static gama.extension.traffic.driving.DrivingSkill.getPolitenessFactor;
import static gama.extension.traffic.driving.DrivingSkill.getProbaUseLinkedRoad;
import static gama.extension.traffic.driving.DrivingSkill.getRightSideDriving;
import static gama.extension.traffic.driving.DrivingSkill.getSpeed;
import static gama.extension.traffic.driving.DrivingSkill.getTimeSinceLC;
import static gama.extension.traffic.driving.DrivingSkill.getVehicleLength;
import static gama.extension.traffic.driving.DrivingSkill.setFollower;
import static gama.extension.traffic.driving.DrivingSkill.setLeadingDistance;
import static gama.extension.traffic.driving.DrivingSkill.setLeadingSpeed;
import static gama.extension.traffic.driving.DrivingSkill.setLeadingVehicle;
import static gama.extension.traffic.driving.DrivingSkill.setTimeSinceLC;
import static gama.extension.traffic.driving.carfollowing.Utils.findFollower;
import static gama.extension.traffic.driving.carfollowing.Utils.findLeader;
import static gama.extension.traffic.driving.carfollowing.Utils.rescaleProba;
