...
experiment "Show heatmap" type: gui {
	output synchronized:true{
		...
		display "Instant heatmap with palette" type: 2d axes: false background: #black  {
		...
		display "History heatmap with gradient" type: 2d axes: false background: #black camera: #from_up_front {
