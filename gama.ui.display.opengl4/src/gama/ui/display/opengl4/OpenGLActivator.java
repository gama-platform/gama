/*******************************************************************************************************
 *
 * OpenGLActivator.java, in gama.ui.display.opengl4, is part of the source code of the GAMA modeling and simulation
 * platform (v.2025-03).
 *
...
public class OpenGLActivator extends GamaBundleActivator {
	...
	private void gatherOpenGLProperties() {
		...
		try {
			...
			gl.glGetFloatv(GL4.GL_SMOOTH_LINE_WIDTH_GRANULARITY, fresult, 0);
