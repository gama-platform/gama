/*******************************************************************************************************
 *
 * JOGLRenderer.java, in gama.ui.display.opengl4, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
import gama.ui.display.opengl4.renderer.helpers.AbstractRendererHelper.Pass;
...
public class JOGLRenderer extends AbstractDisplayGraphics implements IOpenGLRenderer {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getWidth()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getHeight()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getRealWorldPointFromWindowPoint (java.awt.Point)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getCameraHelper()
	 */
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getKeystoneHelper()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getPickingHelper()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getOpenGLHelper()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getLightHelper()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 *
	 * @see gama.ui.display.opengl4.renderer.IOpenGLRenderer#getSceneHelper()
	 */
	@Override
