/*******************************************************************************************************
 *
 * ModelScene.java, in gama.ui.display.opengl4, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
...
import gama.ui.display.opengl4.scene.layers.AxesLayerObject;
import gama.ui.display.opengl4.scene.layers.FrameLayerObject;
import gama.ui.display.opengl4.scene.layers.LayerObject;
import gama.ui.display.opengl4.scene.layers.LayerObjectWithTrace;
import gama.ui.display.opengl4.scene.layers.OverlayLayerObject;
