...
public class GamlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GamlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getS_LayerAccess().getAlternatives(), "rule__S_Layer__Alternatives");
			builder.put(grammarAccess.get_SpeciesKeyAccess().getAlternatives(), "rule___SpeciesKey__Alternatives");
			builder.put(grammarAccess.get_GeneralKeyAccess().getAlternatives(), "rule___GeneralKey__Alternatives");
			...
			builder.put(grammarAccess.getArgumentPairAccess().getAlternatives(), "rule__ArgumentPair__Alternatives");
			builder.put(grammarAccess.getArgumentPairAccess().getAlternatives_0_0_1(), "rule__ArgumentPair__Alternatives_0_0_1");
			builder.put(grammarAccess.getArgumentPairAccess().getOpAlternatives_0_0_1_1_0_0(), "rule__ArgumentPair__OpAlternatives_0_0_1_1_0_0");
			...
			builder.put(grammarAccess.getS_GeneralAccess().getGroup(), "rule__S_General__Group__0");
			...
			builder.put(grammarAccess.getS_GraphicsLayerAccess().getGroup(), "rule__S_GraphicsLayer__Group__0");
			builder.put(grammarAccess.getS_EventLayerAccess().getGroup(), "rule__S_EventLayer__Group__0");
			builder.put(grammarAccess.getS_OverlayLayerAccess().getGroup(), "rule__S_OverlayLayer__Group__0");
			builder.put(grammarAccess.getS_OtherLayerAccess().getGroup(), "rule__S_OtherLayer__Group__0");
			...
			builder.put(grammarAccess.getArgumentPairAccess().getGroup_0_0(), "rule__ArgumentPair__Group_0_0__0");
			builder.put(grammarAccess.getArgumentPairAccess().getGroup_0_0_1_0(), "rule__ArgumentPair__Group_0_0_1_0__0");
			builder.put(grammarAccess.getArgumentPairAccess().getGroup_0_0_1_1(), "rule__ArgumentPair__Group_0_0_1_1__0");
			...
			builder.put(grammarAccess.getS_GeneralAccess().getKeyAssignment_0(), "rule__S_General__KeyAssignment_0");
			builder.put(grammarAccess.getS_GeneralAccess().getFirstFacetAssignment_1(), "rule__S_General__FirstFacetAssignment_1");
			builder.put(grammarAccess.getS_GeneralAccess().getExprAssignment_2(), "rule__S_General__ExprAssignment_2");
			...
			builder.put(grammarAccess.getS_GraphicsLayerAccess().getKeyAssignment_0(), "rule__S_GraphicsLayer__KeyAssignment_0");
			builder.put(grammarAccess.getS_GraphicsLayerAccess().getExprAssignment_1(), "rule__S_GraphicsLayer__ExprAssignment_1");
			builder.put(grammarAccess.getS_EventLayerAccess().getKeyAssignment_0(), "rule__S_EventLayer__KeyAssignment_0");
			builder.put(grammarAccess.getS_EventLayerAccess().getExprAssignment_1(), "rule__S_EventLayer__ExprAssignment_1");
			builder.put(grammarAccess.getS_OverlayLayerAccess().getKeyAssignment_0(), "rule__S_OverlayLayer__KeyAssignment_0");
			builder.put(grammarAccess.getS_OtherLayerAccess().getKeyAssignment_0(), "rule__S_OtherLayer__KeyAssignment_0");
			builder.put(grammarAccess.getS_OtherLayerAccess().getFirstFacetAssignment_1(), "rule__S_OtherLayer__FirstFacetAssignment_1");
			builder.put(grammarAccess.getS_OtherLayerAccess().getExprAssignment_2(), "rule__S_OtherLayer__ExprAssignment_2");
			...
			builder.put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_1_0_0(), "rule__ArgumentPair__OpAssignment_0_0_1_0_0");
			builder.put(grammarAccess.getArgumentPairAccess().getOpAssignment_0_0_1_1_0(), "rule__ArgumentPair__OpAssignment_0_0_1_1_0");
			builder.put(grammarAccess.getArgumentPairAccess().getRightAssignment_0_0_2(), "rule__ArgumentPair__RightAssignment_0_0_2");
