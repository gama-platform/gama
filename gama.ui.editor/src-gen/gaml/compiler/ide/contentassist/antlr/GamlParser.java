...
public class GamlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GamlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getS_OtherLayerAccess().getAlternatives_1(), "rule__S_OtherLayer__Alternatives_1");
			...
			builder.put(grammarAccess.getS_OtherLayerAccess().getGroup_1_0(), "rule__S_OtherLayer__Group_1_0__0");
			builder.put(grammarAccess.getS_OtherLayerAccess().getGroup_1_0_0(), "rule__S_OtherLayer__Group_1_0_0__0");
			...
			builder.put(grammarAccess.getS_GeneralAccess().getExprAssignment_1(), "rule__S_General__ExprAssignment_1");
			...
			builder.put(grammarAccess.getS_OtherLayerAccess().getExprAssignment_1_0_0_0(), "rule__S_OtherLayer__ExprAssignment_1_0_0_0");
