...
public class GamlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GamlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getS_OtherLayerAccess().getAlternatives_4(), "rule__S_OtherLayer__Alternatives_4");
			...
			builder.put(grammarAccess.getS_OtherLayerAccess().getFacetsAssignment_3(), "rule__S_OtherLayer__FacetsAssignment_3");
			builder.put(grammarAccess.getS_OtherLayerAccess().getBlockAssignment_4_0(), "rule__S_OtherLayer__BlockAssignment_4_0");
