/*******************************************************************************************************
 *
 * RevealInWorkspace.java, in gama.ui.navigator, is part of the source code of the GAMA modeling and simulation platform
 * (v.2025-03).
 *
 ...
 */
public class RevealInWorkspace extends AbstractHandler {
	...
	public Object execute(final ExecutionEvent event) throws ExecutionException {
		...
		if (!(part instanceof final GamaNavigator nav)) return null;
		final List<Object> selection = sel.toList();
		final List<WrappedFile> newSelection = new ArrayList<>();
		for (final Object o : selection) {
			if (o instanceof LinkedFile) { newSelection.add(((LinkedFile) o).getTarget()); }
		}
