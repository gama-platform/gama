...
public class FlatButton extends Canvas implements PaintListener, Listener {
	...
	final Rectangle rect = new Rectangle(0, Math.round(v_inset), preferredWidth - rightPadding, preferredHeight);
	...
	final float textWidth = computeWidthOfText();
    ...
    /**
     * Sets the right padding. The width of the container composite should
     * already have been sufficiently enlarged to host this extra padding
     *
     * @param buttonPadding
     *            the new padding
     */
    public void setRightPadding(final int buttonPadding) {
