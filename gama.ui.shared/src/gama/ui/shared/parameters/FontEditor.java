 ...
 */
public class FontEditor extends AbstractEditor<IFont> {
	 ...
	 *            the l
	 */
	FontEditor(final IAgent agent, final IParameter param, final EditorListener<IFont> l) {
		super(agent, param, l);
	}
	...
	protected void displayParameterValue() {
		...
		final IFont data = currentValue != null ? currentValue
		...
		// if (old != null && old !=
		// WorkbenchHelper.getDisplay().getSystemFont()) { old.dispose(); }
