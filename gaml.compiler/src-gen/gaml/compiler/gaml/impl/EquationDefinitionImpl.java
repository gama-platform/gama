 ...
 * </p>
 * <ul>
 *   <li>{@link gaml.compiler.gaml.impl.EquationDefinitionImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquationDefinitionImpl extends GamlDefinitionImpl implements EquationDefinition
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GamlPackage.EQUATION_DEFINITION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GamlPackage.EQUATION_DEFINITION__NAME:
        return getName();
    }
