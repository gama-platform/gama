 ...
 * </p>
 * <ul>
 *   <li>{@link gaml.compiler.gaml.impl.StandaloneExperimentImpl#getFacets <em>Facets</em>}</li>
 *   <li>{@link gaml.compiler.gaml.impl.StandaloneExperimentImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link gaml.compiler.gaml.impl.StandaloneExperimentImpl#getKey <em>Key</em>}</li>
 *   <li>{@link gaml.compiler.gaml.impl.StandaloneExperimentImpl#getName <em>Name</em>}</li>
 *   <li>{@link gaml.compiler.gaml.impl.StandaloneExperimentImpl#getImportURI <em>Import URI</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StandaloneExperimentImpl extends EntryImpl implements StandaloneExperiment
{
  ...
  {
    if (baseClass == FacetsAndBlock.class)
    {
      switch (derivedFeatureID)
      {
        case GamlPackage.STANDALONE_EXPERIMENT__FACETS: return GamlPackage.FACETS_AND_BLOCK__FACETS;
        case GamlPackage.STANDALONE_EXPERIMENT__BLOCK: return GamlPackage.FACETS_AND_BLOCK__BLOCK;
        case GamlPackage.STANDALONE_EXPERIMENT__KEY: return GamlPackage.FACETS_AND_BLOCK__KEY;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == FacetsAndBlock.class)
    {
      ...
      {
        case GamlPackage.FACETS_AND_BLOCK__FACETS: return GamlPackage.STANDALONE_EXPERIMENT__FACETS;
        case GamlPackage.FACETS_AND_BLOCK__BLOCK: return GamlPackage.STANDALONE_EXPERIMENT__BLOCK;
        case GamlPackage.FACETS_AND_BLOCK__KEY: return GamlPackage.STANDALONE_EXPERIMENT__KEY;
        default: return -1;
      }
    }
