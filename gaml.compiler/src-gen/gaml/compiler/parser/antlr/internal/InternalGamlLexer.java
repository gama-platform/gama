...
public class InternalGamlLexer extends Lexer {
    ...
    public final void mT__53() throws RecognitionException {
        try {
            int _type = T__53;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:50:7: ( 'skill' )
            // InternalGaml.g:50:9: 'skill'
            {
            match("skill"); 
    ...
    public final void mRULE_KEYWORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8637:14: ( ( 'each' | 'self' | 'myself' | 'nil' | 'super' ) )
            // InternalGaml.g:8637:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            {
            // InternalGaml.g:8637:16: ( 'each' | 'self' | 'myself' | 'nil' | 'super' )
            int alt1=5;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_INTEGER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8639:14: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // InternalGaml.g:8639:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // InternalGaml.g:8639:16: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8639:21: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:8639:30: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8641:14: ( ( 'true' | 'false' ) )
            // InternalGaml.g:8641:16: ( 'true' | 'false' )
            {
            // InternalGaml.g:8641:16: ( 'true' | 'false' )
            int alt4=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8643:9: ( ( '2d' | '3d' | '2D' | '3D' | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )* ) )
            // InternalGaml.g:8643:11: ( '2d' | '3d' | '2D' | '3D' | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )* )
            {
            // InternalGaml.g:8643:11: ( '2d' | '3d' | '2D' | '3D' | ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )* )
            int alt6=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt6) {
                ...
                case 4 :
                    ...
                    break;
                case 5 :
                    // InternalGaml.g:8643:32: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
                    {
                    ...
                    // InternalGaml.g:8643:60: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' | '0' .. '9' )*
                    loop5:
                    do {
                        int alt5=2;
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8645:13: ( ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? ) )
            // InternalGaml.g:8645:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            {
            // InternalGaml.g:8645:15: ( '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )? )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalGaml.g:8645:16: '1' .. '9' ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    matchRange('1','9'); 
                    // InternalGaml.g:8645:25: ( '0' .. '9' )*
                    loop7:
                    do {
                        int alt7=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalGaml.g:8645:38: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:8645:42: ( '0' .. '9' )+
                            int cnt8=0;
                            loop8:
                            do {
                                int alt8=2;
                    ...
                    // InternalGaml.g:8645:56: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt12=2;
                    ...
                    switch (alt12) {
                        case 1 :
                            // InternalGaml.g:8645:57: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8645:92: '0' ( '.' ( '0' .. '9' )+ )? ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    match('0'); 
                    // InternalGaml.g:8645:96: ( '.' ( '0' .. '9' )+ )?
                    int alt14=2;
                    ...
                    switch (alt14) {
                        case 1 :
                            // InternalGaml.g:8645:97: '.' ( '0' .. '9' )+
                            {
                            match('.'); 
                            // InternalGaml.g:8645:101: ( '0' .. '9' )+
                            int cnt13=0;
                            loop13:
                            do {
                                int alt13=2;
                    ...
                    // InternalGaml.g:8645:115: ( ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt17=2;
                    ...
                    switch (alt17) {
                        case 1 :
                            // InternalGaml.g:8645:116: ( 'E' | 'e' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8647:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalGaml.g:8647:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalGaml.g:8647:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // InternalGaml.g:8647:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalGaml.g:8647:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop19:
                    do {
                        int alt19=3;
                        ...
                        switch (alt19) {
                    	case 1 :
                    	    // InternalGaml.g:8647:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    ...
                    break;
                case 2 :
                    // InternalGaml.g:8647:81: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalGaml.g:8647:86: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop20:
                    do {
                        int alt20=3;
                        ...
                        switch (alt20) {
                    	case 1 :
                    	    // InternalGaml.g:8647:87: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8649:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalGaml.g:8649:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalGaml.g:8649:24: ( options {greedy=false; } : . )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalGaml.g:8655:16: ( . )
            // InternalGaml.g:8655:18: .
            {
            matchAny(); 
    ...
    static final String[] DFA27_transitionS = {
            ...
            "\1\u018d",
            "\1\u018e",
            "\1\66\13\uffff\12\66\1\u0191\6\uffff\32\66\4\uffff\1\u018f\1\uffff\13\66\1\u0190\16\66",
            "\1\66\13\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "\1\u0194",
            "\1\u0195",
            "",
            ...
            "",
            "\1\u01ef",
            "\1\66\13\uffff\12\66\1\u01f0\6\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "\1\66\13\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "",
            "\1\u01f3",
            "\1\u01f4",
            ...
            "\1\u01f6",
            "\1\u01f7",
            "\1\66\13\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\22\66\1\u01f8\7\66",
            "\1\u01fa",
            "\1\u01fb",
            "\1\66\13\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "\1\66\13\uffff\12\66\7\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            ...
            "",
            "",
            "\1\66\13\uffff\12\66\1\u022e\6\uffff\32\66\4\uffff\1\66\1\uffff\32\66",
            "\1\u0230",
            "\1\u0231",
            "\1\u0232",
            "\1\u0233",
