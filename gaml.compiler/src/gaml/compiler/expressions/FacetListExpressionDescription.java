 ...
 * so it can be stored in a symbol's facet map and later retrieved by {@link gaml.compiler.descriptions.DoDescription}.
 *
 * <p>
 ...
 *
 * @author drogoul
 * @see gaml.compiler.descriptions.DoDescription#validate()
