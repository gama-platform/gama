/*******************************************************************************************************
 *
 * StatementRemoteWithChildrenDescription.java, in gaml.compiler, is part of the source code of the GAMA modeling and
...
public class StatementRemoteWithChildrenDescription extends StatementWithChildrenDescription {
	...
	public IModelDescription getModelDescription() {
		IModelDescription result = super.getModelDescription();
	...
	@Override
	public ITypeDescription getDescriptionDeclaringAction(final String name, final boolean superInvocation) {
		ITypeDescription result = super.getDescriptionDeclaringAction(name, superInvocation);
		if (result == null && alternateEnclosingDescription != null) {
