/*******************************************************************************************************
 *
 * StatementWithChildrenDescription.java, in gaml.compiler, is part of the source code of the GAMA modeling and
...
public class StatementWithChildrenDescription extends StatementDescription {
	...
	public IExpression addTemp(final IDescription declaration, final String facet, final String name,
		...
		boolean isMyself = IKeyword.MYSELF.equals(name);
		if (!isMyself) {
	...
	public IVarExpression addNewTempIfNecessary(final String facetName, final IType type) {
		if (IKeyword.LOOP.equals(getKeyword()) && IKeyword.NAME.equals(facetName))
			// Case of loops: the variable is inside the loop
