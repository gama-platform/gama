...
public record ConstructorForSpecies(ISpeciesDescription target, Arguments parameters) implements IOperator {
	 ...
	 */
	public ConstructorForSpecies(final IDescription callerContext, final ISpeciesDescription target,
	...
	public String getTitle() {
		...
		sb.append("constructor for species ").append(getName());
		return sb.toString();
	...
	public IExpression resolveAgainst(final IScope scope) {
		return new ConstructorForSpecies(target, parameters == null ? null : parameters.resolveAgainst(scope));
	}
