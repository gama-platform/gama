...
if [[ ${change} == *"gama.annotations"* ]] || [[ $MSG == *"ci gama.annotations"* ]] || [[ $MSG == *"ci fullbuild"* ]]; then
	mvn_deploy gama.annotations 		
	MSG+=" ci fullbuild "
fi
...
if [[ $MSG == *"ci fullbuild"* ]]; then		
	...
	if [[ ${change} == *"msi.gama.core"* ]] || [[ ${change} == *"msi.gama.headless"* ]] || [[ ${change} == *"msi.gama.lang.gaml"* ]] || [[ ${change} == *"msi.gama.processor"* ]] || [[ ${change} == *"gama.annotations"* ]] || [[ ${change} == *"gama.annotations"* ]] || [[ $MSG == *"ci ummisco.gama.feature.core"* ]]; then
